	 ...
	 <?php if($product->has_child()):
		 ...
		 <?php $image_id = $variation['image_id']; $post_image_id = get_post_thumbnail_id();
		 	if($image_id != $post_image_id): ?>
	  		<div class="img-wrapper" data-option="<?php $attributes = $variation['attributes']; foreach($attributes as $attribute): print_r($attribute); endforeach; ?>"><img class="gallery-img" src="<?php echo $variation['image']['url']; ?>" alt=""></div>
			<?php endif; ?>
	  <?php endforeach; endif; ?>
</div>
