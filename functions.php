...
function html5blank_header_scripts() {
    if ( $GLOBALS['pagenow'] != 'wp-login.php' && ! is_admin() ) {
        if ( HTML5_DEBUG ) {
            ...
            wp_register_script( 'jquery', get_template_directory_uri() . '/js/lib/jquery-3.5.1.min.js', array(), '3.5.1' );

            // Conditionizr
            wp_register_script( 'conditionizr', get_template_directory_uri() . '/js/lib/conditionizr-4.3.0.min.js', array(), '4.3.0' );

            // Modernizr
            wp_register_script( 'modernizr', get_template_directory_uri() . '/js/lib/modernizr.min.js', array(), '2.8.3' );

            // Slick
            wp_register_script( 'slick', get_template_directory_uri() . '/js/lib/slick.min.js', array(), '1.8.1' );

            // Steps
            wp_register_script( 'steps', get_template_directory_uri() . '/js/lib/jquery.steps.js', array(), '1.1.0' );

            wp_register_script( 'fittext', get_template_directory_uri() . '/js/lib/jquery.fittext.js', array(), '1.2' );
